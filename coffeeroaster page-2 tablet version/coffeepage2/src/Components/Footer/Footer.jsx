...
import "./footer.scss";
import pastkirasm from "../../image/pastkirasm.png";
    ...
    <>
      <div className="footer">
        <div className="footercha">
          <div className="rasm">
            <img src={pastkirasm} alt="Coffeeroasters"></img>
          </div>
          <div className="pastkinavbar">
            <div className="uy">
              <a href="../coffeeroasters page-1 tablet version/index.html">
                HOME
              </a>
            </div>
